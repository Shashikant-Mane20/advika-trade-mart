...
//       {/* Main Content */}
//       <div className="text-center max-w-md md:max-w-lg lg:max-w-xl space-y-4 z-10">
//         <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-amber-200 font-dancing">
//           Advika Trade Mart
//         </h1>
//         <p className="text-gray-300 text-base md:text-lg lg:text-xl mt-2 font-roboto">
//           Premium Dry Fruits Delivered Fresh to Your Doorstep
//         </p>
...
//             We're Coming Soon!
//           </h2>
//           <p className="text-gray-200 text-sm md:text-base lg:text-lg mt-2">
//             Stay tuned for the grand opening of our online store.
//           </p>

//           <div className="flex flex-col md:items-center text-gray-200 text-sm md:text-base lg:text-lg space-y-2">
//             <div className="flex items-center">
//               <span className="font-bold">📞 Contact:</span>
//               <span className="ml-2 font-mono text-amber-200">
//                 +91 9930055555, +91 7700022222
...
//             <div>
//               <a
//                 href="http://advikatrademart.com"
//                 className="text-white underline centered-link"
//               >
//                 Advika Trademart.com
//               </a>
//             </div>
